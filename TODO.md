...
## Code quality and functionality
  ...
  - [ ] (pre-release) Unify asset handling: host all model weights (refl2prop, emulator, datadriven albedo) on HuggingFace, remove bundled refl2prop weights from source tree, make all processors use the same managed-asset-only pattern with no silent bundled fallback
